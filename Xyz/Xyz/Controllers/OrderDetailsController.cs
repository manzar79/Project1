...
namespace Xyz.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DetailsID,OrderID,Quantity,OrderPrice")] OrderDetails orderDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DetailsID,OrderID,Quantity,OrderPrice")] OrderDetails orderDetails)
        {
            if (ModelState.IsValid)
            {
